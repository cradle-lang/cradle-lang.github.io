...
The command is hidden from the top-level help output because Debian package
installation generates and installs completions automatically. Use it directly
when maintaining a manual installation.
