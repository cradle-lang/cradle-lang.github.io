...
<div
  className="scenarioReferenceFlow"
  role="img"
  aria-label='The Client instance is declared, defined, and then referenced by a network endpoint and an event'
>
  <div className="scenarioTopologyNode scenarioReferenceStep">
    <span className="scenarioReferenceType">Declaration list</span>
    <code>instances()</code>
  </div>
  <span className="scenarioTopologyArrow" aria-hidden="true">→</span>
  <div className="scenarioTopologyNode scenarioReferenceStep">
    <span className="scenarioReferenceType">Declaration</span>
    <code>instance("Client")</code>
  </div>
  <span className="scenarioTopologyArrow" aria-hidden="true">→</span>
  <div className="scenarioTopologyNode scenarioReferenceStep">
    <span className="scenarioReferenceType">Definition</span>
    <code>instance("Client")</code>
  </div>
  <span className="scenarioTopologyArrow" aria-hidden="true">→</span>
  <div className="scenarioTopologyNode scenarioReferenceStep">
    <span className="scenarioReferenceType">Network reference</span>
    <code>endpoint("Client", …)</code>
  </div>
  <span className="scenarioTopologyArrow" aria-hidden="true">→</span>
  <div className="scenarioTopologyNode scenarioReferenceStep">
    <span className="scenarioReferenceType">Event reference</span>
    <code>instance("Client")</code>
  </div>
</div>
...
<div
  className="scenarioReferenceFlow"
  role="img"
  aria-label='The InitializationScript object is declared, defined, associated with an instance, and referenced by an event'
>
  <div className="scenarioTopologyNode scenarioReferenceStep">
    <span className="scenarioReferenceType">Declaration list</span>
    <code>metadata()</code>
  ...
  <span className="scenarioTopologyArrow" aria-hidden="true">→</span>
  <div className="scenarioTopologyNode scenarioReferenceStep">
    <span className="scenarioReferenceType">Instance association</span>
    <code>object("InitializationScript")</code>
  </div>
  <span className="scenarioTopologyArrow" aria-hidden="true">→</span>
  <div className="scenarioTopologyNode scenarioReferenceStep">
...
<div
  className="scenarioReferenceFlow"
  role="img"
  aria-label='The lan_0 network is declared, defined, and connected to the Client and Router instances through endpoints'
>
  <div className="scenarioTopologyNode scenarioReferenceStep">
    <span className="scenarioReferenceType">Declaration list</span>
    <code>networks()</code>
  ...
  <span className="scenarioTopologyArrow" aria-hidden="true">→</span>
  <div className="scenarioTopologyNode scenarioReferenceStep">
    <span className="scenarioReferenceType">Endpoint references</span>
    <code>Client + Router</code>
  </div>
</div>
...
<div className="architecture-flow architecture-workflow">
  ...
  <div className="architecture-flow-step-backend">Optional backend generation</div>
