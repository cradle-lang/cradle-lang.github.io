...
It should have a matching event definition.
...
6. Declare and define objects.
7. Define the event lifecycle.
8. Add events and dependencies.
9. Check every named reference.
10. Validate the scenario.
11. Inspect the intermediate representation if required.
12. Compile the scenario.
13. Generate target-specific files only when required.
