...
<div
  className="networkReferenceGraph"
  role="img"
  aria-label='The endpoint named Client references the declared Client instance and connects it to the lan_0 network'
>
  <div className="networkReferenceNode">
    <span className="networkReferenceType">Instance</span>
    <code>instance("Client")</code>
  </div>

  <div className="networkReferenceConnection" aria-hidden="true">
    <span className="networkReferenceLine"></span>
    <span className="networkReferenceLabel">referenced by name</span>
  </div>

  <div className="networkReferenceNode networkReferenceNodeEndpoint">
    <span className="networkReferenceType">Endpoint</span>
    <code>endpoint("Client", "DHCP")</code>
  </div>

  <div className="networkReferenceConnection" aria-hidden="true">
    <span className="networkReferenceLine"></span>
    <span className="networkReferenceLabel">belongs to</span>
  </div>

  <div className="networkReferenceNode">
    <span className="networkReferenceType">Network</span>
...
<div
  className="scenarioRoutedGraph"
  role="img"
  aria-label="Client connects to Router through lan_0, and Router connects to Server through lan_1"
>

  <div className="scenarioRoutedNetwork scenarioRoutedNetworkLeft">
    <div className="scenarioNetworkGraphHeader">
      <span>Network</span>
      <code>lan_0</code>
    </div>

    <div className="scenarioRoutedNetworkBody">
  ...
  <div className="scenarioRoutedConnector" aria-hidden="true" />

  <div className="scenarioGraphInstance scenarioRoutedRouter">
    <span className="scenarioGraphInstanceType">Router</span>
    <strong>Router</strong>
    <code>192.168.10.1 / 192.168.20.1</code>
  </div>

  <div className="scenarioRoutedConnector" aria-hidden="true" />

  <div className="scenarioRoutedNetwork scenarioRoutedNetworkRight">
    <div className="scenarioNetworkGraphHeader">
      <span>Network</span>
      <code>lan_1</code>
    </div>
