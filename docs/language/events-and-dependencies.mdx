...
The Hello World scenario follows this structure.
...
- reference `instance("HelloWorld")`
- use `bash`
- run the `HelloWorld` object
- do not request root privileges
- use zero-second pauses
- use `waitfor("false")`
- use the same scheduled execution timestamp

The descriptions distinguish the lifecycle phases.
