...
A simplified view of the Hello World scenario structure is:
...
:::note
This shortened example demonstrates the relationships between the major language elements. See [First Scenario](../getting-started/first-scenario) for the complete Hello World scenario.
:::
