...
<div className="architecture-flow">
  ...
  <div>Optional backend plugin</div>
...
The canonical HelloWorld-Win source is maintained on the
[HelloWorld-Win example page](../examples/hello-world). Its top-level sections
