...
- an `emit` target is unknown
- a deployment backend cannot complete a requested stage
...
| `cxc deploy` | The selected deployment stages complete. | Backend lookup, lowering, provisioning or event execution fails. |
