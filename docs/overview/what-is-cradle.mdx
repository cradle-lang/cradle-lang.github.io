...
These concepts form the main [CRADLE language structure](../introduction/sections).
...
- Learn how a scenario is organized in [CRADLE language structure](../introduction/sections.md).
- See a small conceptual example in [Hello World](../introduction/helloworld.md).
- Learn how external classification metadata is represented in [Heuristic Annotations](../introduction/heuristic.md).
